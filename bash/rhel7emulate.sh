...
echo "Installation Updating system..."
dnf update -y

echo "System Installing KDE Plasma Desktop (if not already installed)..."
...
echo " Downloading RHEL 7 wallpaper..."
...
echo " Setting wallpaper (via Plasma config)..."
plasma-apply-wallpaperimage "$WALLPAPER_PATH"

echo "Installation Configuring GTK apps to use Adwaita theme..."
...
echo "[WARNING] Please manually configure panels via KDE's panel settings to match RHEL 7 layout:"
echo " - Top panel with Application Menu and System Tray"
echo " - Bottom panel with Task Manager and Pager"

echo "[PASS] KDE RHEL 7-style setup complete!"
